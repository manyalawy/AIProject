public class Matrix {
    ...
    public static void main(String[] args) {
        ...
        Node node = new Node(null,Operators.LEFT,"5,5;2;1,2,0,0;2,1;2,0,0,4,0,3,0,1;3,3,3,3;4,4,3,3,3,3,4,4;4,0,17,false,false,1,2,54,false,false,0,0,46,false,false,4,1,22,false,false",0,0);
        System.out.println(Helpers.stateToGrid(node.state).neo.x+"  "+Helpers.stateToGrid(node.state).neo.y);
        Node newNode = Actions.Up(node);
        System.out.println(Helpers.stateToGrid(newNode.state).neo.x + "  " + Helpers.stateToGrid(newNode.state).neo.y);
